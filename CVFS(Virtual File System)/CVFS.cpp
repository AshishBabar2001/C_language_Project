...
void man(char *name)
{
    ...
    {
        printf("ERROR : Mo manual entry available.\n");
    }    
}
...
void DisplayHelp()
{
    ...
    printf("closeall : To close all contents from file.\n");
...
int main()
{
    ...
    while (1)
    {
        ...
        if (count == 1)
        {
            ...
            {
                CloseAllFile();
                printf("All files closed successflly\n");
                continue;
            }
            ...
            {
                printf("Terminating the Ashish's Virtual File System\n");
                break;
            }
            else
            {
